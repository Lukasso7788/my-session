...
export function LiveKitBottomBar(props: {
    ...
    const labeledControlClass = "h-10 min-w-10 px-1.5 rounded-2xl flex flex-col items-center justify-center gap-[5px] transition md:h-11 md:min-w-11 md:px-2 md:py-1";
