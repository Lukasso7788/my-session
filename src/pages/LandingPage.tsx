    ...
    return (
        <div className="border border-[#DBD8D8] rounded-[28px] bg-white p-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button className="h-12 rounded-full px-6 text-[14px] font-semibold bg-[#111827] text-white hover:opacity-90 transition w-full sm:w-auto">
                    Join session
                </button>
            </div>
        </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div className="bg-white border border-[#EAEAEA] rounded-[24px] p-5 flex flex-col">
                                    ...
                                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                                        <button
                                            onClick={() => navigate("/sessions")}
                                            className="h-12 rounded-full px-6 text-[14px] font-semibold bg-[#111827] text-white hover:opacity-90 transition w-full sm:w-auto"
                                        >
                                            Join a session
                                        </button>
                                        <button
                    ...
                    <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <FeatureCard
                            ...
                            bullets={[
                                ...
                                "Quick access to intentions panel",
                            ]}
                        />
                    </div>
                </section>
                ...
                <section className="py-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <FeatureCard
                            ...
                            bullets={[
                                "Unblock tasks fast",
                                "Stay inside the session structure",
                                "Reduce context switching & doomscrolling",
                            ]}
                        />
                    </div>
                </section>
