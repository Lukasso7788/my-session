...
      {/* ОСНОВНОЙ КОНТЕЙНЕР ДЛЯ H1, СВИТЧЕРА И СПИСКА СЕССИЙ */}
      <main className="max-w-[1280px] mx-auto px-8 pb-12">
        {/* H1 с верхним паддингом 100px и нижним отступом 50px */}
        <div className="pt-[100px] mb-[50px] text-center">
          <h1
            className="
              text-[24px]
              md:text-[28px]
...
        </div>
        
        {/* КОНТЕЙНЕР ДЛЯ СВИТЧЕРА И СПИСКА СЕССИЙ - занимает всю ширину */}
...
          {/* SESSION LIST CONTAINER с рамкой и паддингом 32px */}
